...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Anomaly Transformer 在线推理 replay runner（常驻模型，顺序回放窗口）"
    )
...
def main() -> int:
    ...
    interval_ms = args.interval_ms if args.interval_ms > 0 else 1000.0
    ...
    if args.prefetch:
        print(f"Prefetching {max_steps} Anomaly Transformer samples into CPU memory...")
    ...
    print("\n" + "=" * 72)
    print("Anomaly Transformer Realtime Replay Summary")
    print("=" * 72)
