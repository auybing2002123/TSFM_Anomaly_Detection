...
def main():
    parser = argparse.ArgumentParser(description='MSDS V2 训练')
    ...
    parser.add_argument('--checkpoint-dir', type=str, default='checkpoints/msds/v2')
    ...
    parser.add_argument('--num-gat-layers', type=int, default=2, help='GATv2 层数')
    parser.add_argument('--gat-heads', type=int, default=4, help='GATv2 注意力头数')
    parser.add_argument('--num-temporal-layers', type=int, default=2, help='时序注意力层数')
    parser.add_argument('--temporal-heads', type=int, default=4, help='时序注意力头数')
    ...
    print("=" * 60)
    print("MSDS V2 训练 (GATv2 + Temporal Attention)")
    print("=" * 60)
    ...
    print(f"Temporal: {args.num_temporal_layers} 层, {args.temporal_heads} heads")
    ...
    model = MultiModalV2_MSDS(config, adjacency_matrix).to(args.device)
