...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Analyze router/expert usage for stage-2 service-aware MoE")
...
def main() -> int:
    ...
    with torch.no_grad():
        for batch in dataloader:
            ...
            _ = model(metrics, logs, traces, gt_cls, groundtruth_real=gt_real, evaluate=True)
    ...
    summary: Dict[str, Any] = {
        "experiment": "service-aware-moe-routing-diagnostics",
    ...
    print("=" * 72)
    print("Service-aware MoE routing diagnostics")
    print("=" * 72)
    ...
    summary_path = output_dir / f"service_aware_moe_routing_{args.split}_{timestamp_tag()}_summary.json"
