...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Replay a trained RBF-SVM ensemble Eadro-SN strict baseline without retraining."
    )
...
def main() -> None:
    ...
    with resolve(Path(summary["artifacts"]["checkpoint_pickle"])).open("rb") as handle:
    ...
    replay_summary = {
        "baseline": "RBF-SVM ensemble resident replay",
