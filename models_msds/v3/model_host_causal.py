...
3. Host Causal Attention: 跨主机因果融合（V3 核心创新）
...
class MultiModalV3HostCausal_MSDS(nn.Module):
    """
    MSDS V3 模型：跨主机因果发现
    ...
    def _print_info(self):
        ...
        if self.disable_causal:
            print(f"V3 模型初始化完成（消融版：无因果模块）:")
        else:
            print(f"V3 模型初始化完成（跨主机因果发现版）:")
